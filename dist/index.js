var e,t;!function(){let e=document.getElementById("employment-status__select");function t(e){var t=document.createElement("div");t.id="employment-status__wrapper",t.className="employment-status__wrapper",t.innerHTML=e;let o=document.getElementById("employment-status");o.appendChild(t)}e.addEventListener("change",function(){let e=document.getElementById("employment-status__wrapper");e&&e.remove();let o=this.value;switch(o){case"Employed":t(`
    ...
    `)})}(),fetch("https://autos-tokyo.vercel.app/api/fetch-cars").then(e=>e.json()).then(e=>{let t=e.items,o=[],n=[];for(let e=0;e<t.length;e++)o.push(t[e].name),n.push(t[e]["front-page-image"].url),function(e,t){let o=document.querySelectorAll(".cars-form_card");o.forEach(o=>{o.addEventListener("mouseover",o=>{let n=o.target.getAttribute("car");n==e&&function(e,t){let o=document.createElement("div");o.classList.add("car-image__wrapper"),o.innerHTML=`<img src="${t}" alt="${e}">`,document.body.appendChild(o)}(e,t)})})}(o[e],n[e])}).catch(e=>console.error("error:"+e)),e=document.getElementById("yes"),t=document.getElementById("no"),e.addEventListener("change",function(){this.checked&&(function(){var e=document.createElement("div");e.id="co-buyer__sibling",e.className="co-buyer__sibling",e.innerHTML=`
